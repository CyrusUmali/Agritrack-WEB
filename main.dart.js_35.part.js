...
aPw(d){var x=0,w=A.v(y.v),v=1,u,t=[],s=this,r,q,p,o,n,m,l
var $async$Jb=A.q(function(e,f){if(e===1){u=f
x=v}while(true)switch(x){case 0:m=A.ae(d,!1,y.D)
v=3
p=s.Q
if(p.a.a.length===0){p=A.as("Email is required")
throw A.f(p)}s.ay=!0
s.af()
o=y.w
x=6
return A.p(m.np("/auth/forgot-password",A.b(["email",B.n.bB(p.a.a)],o,o)),$async$Jb)
case 6:r=f
if(r.c===200){s.ch=!0
s.a2u("OTP sent to "+p.a.a,d)
A.bb("emailController.text")
A.bb(p.a.a)}else{p=J.z(r.a,"message")
p=A.as("Failed to send OTP: "+A.j(p==null?"Unknown error":p))
...
v=3
p=s.as
if(p.a.a.length===0){p=A.as("OTP is required")
throw A.f(p)}s.ay=!0
s.af()
o=y.w
x=6
return A.p(m.np("/auth/verify-reset-otp",A.b(["email",B.n.bB(s.Q.a.a),"otp",B.n.bB(p.a.a)],o,o)),$async$a1g)
case 6:r=f
if(r.c===200){s.CW=!0
J.z(J.z(r.a,"data"),"resetToken")
s.a2u("OTP verified successfully",d)}else{p=J.z(r.a,"message")
p=A.as("Failed to verify OTP: "+A.j(p==null?"Unknown error":p))
throw A.f(p)}t.push(5)
x=4
break
case 3:v=2
...
o=p.a.a
n=o.length
if(n===0||s.ax.a.a.length===0){p=A.as("Password fields cannot be empty")
throw A.f(p)}if(o!==s.ax.a.a){p=A.as("Passwords do not match")
throw A.f(p)}if(n<8){p=A.as("Password must be at least 8 characters")
throw A.f(p)}s.ay=!0
s.af()
o=y.w
x=6
return A.p(l.np("/auth/reset-password",A.b(["email",B.n.bB(s.Q.a.a),"otp",B.n.bB(s.as.a.a),"newPassword",B.n.bB(p.a.a)],o,o)),$async$a0r)
case 6:r=f
if(r.c===200)s.a2u("Password reset successfully",d)
else{p=J.z(r.a,"message")
p=A.as("Failed to reset password: "+A.j(p==null?"Unknown error":p))
throw A.f(p)}t.push(5)
x=4
break
case 3:v=2
...
var z=a.updateTypes(["~()"])
C.bc_.prototype={
$2(d,e){var x,w,v=null,u=e.a===B.aZ?1/0:440,t=A.hN("assets/DA_image.jpg",v,v,v,v,v,v),s=this.b
...
C.bbP.prototype={
$1(d){var x
if(d==null||J.ex(d))return"Email is required"
...
while(true)switch(x){case 0:x=v.a.gV().fF()?2:3
break
case 2:x=4
return A.p(v.b.Jb(v.c),$async$$0)
...
if(!J.i(J.aM(d),6))return"OTP must be 6 digits"
return null},
$S:57}
C.bbX.prototype={
$0(){var x=0,w=A.v(y.v),v=this
...
break
case 2:x=4
return A.p(v.b.a1g(v.c),$async$$0)
case 4:case 3:return A.t(null,w)}})
return A.u($async$$0,w)},
$S:5}
C.bbY.prototype={
...
$S:57}
C.bbT.prototype={
$1(d){if(d==null||J.ex(d))return"Please confirm your password"
if(!J.i(d,this.a.at.a.a))return"Passwords do not match"
return null},
$S:57}
C.bbU.prototype={
$0(){var x=0,w=A.v(y.v),v=this
...
break
case 2:x=4
return A.p(v.b.a0r(v.c),$async$$0)
case 4:case 3:return A.t(null,w)}})
return A.u($async$$0,w)},
$S:5}
C.bbV.prototype={
...
x(C.GV,A.e2)
x(C.bc_,A.iV)
w(A.fN,[C.bbP,C.bbW,C.bbS,C.bbT])
w(A.hf,[C.bbQ,C.bbR,C.bbX,C.bbY,C.bbZ,C.bbU,C.bbV])
x(C.yp,A.xA)})()
